  ...
  return (
    <div className="p-8 ">
        ...
        <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
            ...
            <h3 className="text-lg font-semibold text-gray-900 ">Basic offers:</h3>
            <p className="mb-4 text-base font-normal text-gray-500 leading-7 ">Personal Blogging Platform, Event Landing Page, Online Portfolio, Local Business Directory, Resume/CV Builder, Educational Resource Hub.</p>

            </li>
            <li className="mb-10 ml-4">
            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-blue-500"></div>
            <time className="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">14 day delivery </time>
            <h3 className="text-lg font-semibold text-gray-900 ">Standard offers:</h3>
